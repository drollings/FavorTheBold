# A testing/debugging version of the Foundation
...
TriggerDef.ET_FND_CREATE_SHIP = App.UtopiaModule_GetNextEventType()
TriggerDef.ET_FND_CREATE_PLAYER_SHIP = App.UtopiaModule_GetNextEventType()
