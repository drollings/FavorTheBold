...
MvamShips = ["FTB_Galaxy", "FTB_GalaxySaucer", "FTB_GalaxyDrive"]
...
MvamReinDistances[0].SetXYZ(0.0, -2.997099, 0.0)
MvamReinDistances[1].SetXYZ(0.0, -2.680729, -1.3403372)
...
def FTB_GalaxySaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		print 'Possible Trouble 1'
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "FTB_GalaxySaucer")
		print 'Possible Trouble 2'
...
def FTB_GalaxyDrive(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "FTB_GalaxyDrive")
