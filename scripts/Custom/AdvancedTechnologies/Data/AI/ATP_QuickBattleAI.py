...
def CreateAI(pShip):
	...
	pAttack = ATP_BasicAttack.CreateAI(pShip, App.ObjectGroup_FromModule("QuickBattle.QuickBattle", "pFriendlies"), Difficulty = QuickBattle.GetCurrentAILevel(), FollowTargetThroughWarp = 1, UseCloaking = 1)
