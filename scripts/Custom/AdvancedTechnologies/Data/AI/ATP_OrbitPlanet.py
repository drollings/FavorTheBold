...
def CreateAI(lArgs):
	...
	pScript.SetRoughDistances(1.15*pPlanet.GetRadius(), pPlanet.GetRadius() *1.25)
	...
	## Conditions:
	#### Condition InRange
	pInRange = App.ConditionScript_Create("Conditions.ConditionInRange", "ConditionInRange", 1.25*pPlanet.GetRadius(),  pShip.GetName(), pPlanet.GetName())
	## Evaluation function:
	...
	pFlyToPlanet.SetScriptModule("Intercept_Dasher")
