# C:\Program Files\Activision\Bridge Commander Dimensions\scripts\Custom\AdvancedTechnologies\Data\Universe\ObjectDef\ShipDef\SubsystemDef\ATP_Shipyard.py
...
#################################################
in1 = App.PositionOrientationProperty_Create("in1")

in1Forward = App.TGPoint3()
in1Forward.SetXYZ(0.000000, 1.000000, 0.000000)
in1Up = App.TGPoint3()
in1Up.SetXYZ(0.000000, 0.000000, 1.000000)
in1Right = App.TGPoint3()
in1Right.SetXYZ(1.000000, 0.000000, 0.000000)
in1.SetOrientation(in1Forward, in1Up, in1Right)
in1Position = App.TGPoint3()
in1Position.SetXYZ(0.000000, -15.000000, -0.600000)
in1.SetPosition(in1Position)
App.g_kModelPropertyManager.RegisterLocalTemplate(in1)
#################################################
centre = App.PositionOrientationProperty_Create("centre")

centreForward = App.TGPoint3()
centreForward.SetXYZ(0.000000, 1.000000, 0.000000)
centreUp = App.TGPoint3()
centreUp.SetXYZ(0.000000, 0.000000, 1.000000)
centreRight = App.TGPoint3()
centreRight.SetXYZ(1.000000, 0.000000, 0.000000)
centre.SetOrientation(centreForward, centreUp, centreRight)
centrePosition = App.TGPoint3()
centrePosition.SetXYZ(0.000000, 0.000000, -0.600000)
centre.SetPosition(centrePosition)
App.g_kModelPropertyManager.RegisterLocalTemplate(centre)
#################################################
out1 = App.PositionOrientationProperty_Create("out1")

out1Forward = App.TGPoint3()
out1Forward.SetXYZ(0.000000, 1.000000, 0.000000)
out1Up = App.TGPoint3()
out1Up.SetXYZ(0.000000, 0.000000, 1.000000)
out1Right = App.TGPoint3()
out1Right.SetXYZ(1.000000, 0.000000, 0.000000)
out1.SetOrientation(out1Forward, out1Up, out1Right)
out1Position = App.TGPoint3()
out1Position.SetXYZ(0.000000, 10.000000, -0.600000)
out1.SetPosition(out1Position)
App.g_kModelPropertyManager.RegisterLocalTemplate(out1)
#################################################
out2 = App.PositionOrientationProperty_Create("out2")

out2Forward = App.TGPoint3()
out2Forward.SetXYZ(0.000000, 1.000000, 0.000000)
out2Up = App.TGPoint3()
out2Up.SetXYZ(0.000000, 0.000000, 1.000000)
out2Right = App.TGPoint3()
out2Right.SetXYZ(1.000000, 0.000000, 0.000000)
out2.SetOrientation(out2Forward, out2Up, out2Right)
out2Position = App.TGPoint3()
out2Position.SetXYZ(0.000000, 16.000000, -0.600000)
out2.SetPosition(out2Position)
App.g_kModelPropertyManager.RegisterLocalTemplate(out2)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("in1", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("centre", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("out1", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("out2", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
