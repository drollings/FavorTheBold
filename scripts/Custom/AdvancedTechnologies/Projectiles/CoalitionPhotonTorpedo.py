...
def Create(pTorp):
	...
	kGlowColor.SetRGBA(255.0 / 255.0, 100.0 / 255.0, 64.0 / 255.0, 0.500000)
	kPlumeColor = App.TGColorA()
	kPlumeColor.SetRGBA(255.0 / 255.0, 65.0 / 255.0, 65.0 / 255.0, 0.600000)
	kCoreColor = App.TGColorA()
	kCoreColor.SetRGBA(255.0 / 255.0, 145.0 / 255.0, 138.0 / 255.0, 0.400000)
