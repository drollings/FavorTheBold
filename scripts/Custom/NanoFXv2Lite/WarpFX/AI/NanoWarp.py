...
class NanoWarp(AI.PlainAI.BaseAI.BaseAI):
	...
	def Update(self):
		...
		# Set our speed to 0.
		import Custom.NanoFXv2Lite.WarpFX.WarpFX_GUI
		pShip.SetSpeed(2.0, App.TGPoint3_GetModelForward(), App.PhysicsObjectClass.DIRECTION_MODEL_SPACE)
		#pShip.SetSpeed(Custom.NanoFXv2Lite.WarpFX.WarpFX_GUI.GetWarpSpeed(), App.TGPoint3_GetModelForward(), App.PhysicsObjectClass.DIRECTION_MODEL_SPACE)
		...
		if self.bWarping == 0:
			...
			# Play the sequence.
			#pWarpSeq.AppendAction(App.TGScriptAction_Create("Custom.NanoFXv2Lite.NanoFX_ScriptActions", "DestroyTGSequence", pWarpSeq))
			pWarpSeq.Play()
