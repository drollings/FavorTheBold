...
def CreatePlasmaFX(pShip, pEvent):
	...
	if pShip:
		...
		fPlasmaColor  = Custom.NanoFXv2Lite.NanoFX_Lib.GetOverrideColor(pShip, "PlasmaFX")
		if (fPlasmaColor == None):
			sRace	      = Custom.NanoFXv2Lite.NanoFX_Lib.GetSpeciesName(pShip)
			fPlasmaColor  = Custom.NanoFXv2Lite.NanoFX_Lib.GetRaceTextureColor(sRace)
		sFile         = "Custom/NanoFXv2/SpecialFX/Gfx/Plasma/Plasma.tga"
		###
					...
					if (pWarpChildCondition <= pWarpChildMaxCondition / 2):
						...
						if (g_sneakerPlasmaCheck == sneakerPlasmaRandom):
							...
							if g_sneakerPlasmaConstant == 0:
								...
								sFile         = "Custom/NanoFXv2/SpecialFX/Gfx/Plasma/Plasma.tga"
								pPlasma = Custom.NanoFXv2Lite.NanoFX_ScriptActions.CreateControllerFX(sFile, 
																pEmitFrom, 
																pAttachTo, 
