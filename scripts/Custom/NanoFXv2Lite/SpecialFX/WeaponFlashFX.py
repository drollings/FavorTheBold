...
def CreateWeaponFlashFX(pObject, pEvent):
	...
	pFlash = Custom.NanoFXv2Lite.NanoFX_ScriptActions.CreateControllerFX(sFile, pEmitFrom, pAttachTo, fSize, vEmitPos, vEmitDir, fFrequency  = 0.01, fLifeTime   = 0.025, iTiming = 1.0, fRed = fColor[0], fGreen = fColor[1], fBlue = fColor[2], fBrightness = 0.8)
