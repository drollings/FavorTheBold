...
def NanoFlyByCamera(pCamera):
	...
	for pFunc, sAttr, kValue in (
		( pMode.SetAttrFloat,	"AwayDistance",			Custom.NanoFXv2Lite.NanoFX_Config.cFX_AwayDistance ),
		( pMode.SetAttrFloat,	"RotateSpeed",			0.0 ),
		( pMode.SetAttrFloat,	"AnticipationTime",		2.0 ),
		( pMode.SetAttrFloat,	"ForwardOffset",		Custom.NanoFXv2Lite.NanoFX_Config.cFX_ForwardDistance ),
...
def NanoViewScreenZoom(pCamera):
	...
	for pFunc, sAttr, kValue in (
		...
		( pMode.SetAttrFloat,	"Distance",			Custom.NanoFXv2Lite.NanoFX_Config.cFX_ViewScreenDefault ),
		( pMode.SetAttrFloat,	"MaximumDistance",		Custom.NanoFXv2Lite.NanoFX_Config.cFX_ViewScreenMax ),
