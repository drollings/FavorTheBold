...
# ConfigPath = "scripts\\Custom\\NanoFXv2Lite\\NanoFX_Config.py"
ConfigPath = "scripts\\Custom\\NanoFXv2Lite\\NanoFX_Config.py"
...
def HandleBridgeFX(pObject, pEvent):
	...
	pEvent.SetDestination(MainConfigure)
	UseBridgeFX = MainMenu.mainmenu.CreateMenuYesNoButton(App.TGString("Enable Bridge Effects"), ET_USEBRIDGEFX, Custom.NanoFXv2Lite.NanoFX_Config.bFX_Enabled, MainConfigure.GetWidth() / 5)
	...
	UseBridgeFX.SetChosen(Custom.NanoFXv2Lite.NanoFX_Config.bFX_Enabled)
	...
	kStates = (	(App.TGString("Low"), ET_BRDFX_EXPSPK_LEVEL, 1),
			...
			(App.TGString("Ultra"), ET_BRDFX_EXPSPK_LEVEL, 4))

	pButton = CreateMenuToggleButton(App.TGString("Explosion Spark Level: "), kStates, Custom.NanoFXv2Lite.NanoFX_Config.bFX_ExpSparkFXLevel - 1, MainConfigure.GetWidth())
	pButton.SetVisible()
	...
	kStates = (	(App.TGString("Low"), ET_BRDFX_DAMSPK_LEVEL, 1),
			...
			(App.TGString("Ultra"), ET_BRDFX_DAMSPK_LEVEL, 4))

	pButton = CreateMenuToggleButton(App.TGString("Damage Spark Level: "), kStates, Custom.NanoFXv2Lite.NanoFX_Config.bFX_DamageSparkFXLevel - 1, MainConfigure.GetWidth())
	pButton.SetVisible()
	...
	bFXDamageSparkDurationPreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.bFX_DamageSparkFXDuration)), UseBridgeFX.GetWidth(), "bFX_DamageSparkFXDuration")
	...
	bFXParticleControlTextPre = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.bFX_ParticleControl)), UseBridgeFX.GetWidth(), "bFX_ParticleControl")
...
def HandleUseBridgeFX(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.bFX_Enabled = App.STButton_Cast(pEvent.GetSource()).IsChosen ()
	WriteConfig()
...
def HandleBrdFX_EXP_SPK(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.bFX_ExpSparkFXLevel = pEvent.GetInt()
	WriteConfig()
...
def HandleBrdFX_DAM_SPK(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.bFX_DamageSparkFXLevel = pEvent.GetInt()
	WriteConfig()
...
def HandleExplosionFX(pObject, pEvent):
	...
	pEvent.SetDestination(MainConfigure)
	UseExpFX = MainMenu.mainmenu.CreateMenuYesNoButton(App.TGString("Enhance Explosion Sequences"), ET_USEEXPFX, Custom.NanoFXv2Lite.NanoFX_Config.eFX_Enabled, MainConfigure.GetWidth() / 5)
	...
	UseExpFX.SetChosen(Custom.NanoFXv2Lite.NanoFX_Config.eFX_Enabled)
	...
	if Custom.NanoFXv2Lite.NanoFX_Config.eFX_LightFlickerFX:
		LightFX.SetChosen(1)
	else:
		LightFX.SetChosen(0)
	...
	if Custom.NanoFXv2Lite.NanoFX_Config.eFX_FixBrightGlows:
		LightFX.SetChosen(1)
	else:
		LightFX.SetChosen(0)
	...
	kStates = (	(App.TGString("Low"), ET_EXPFX_SPK_LEVEL, 1),
			...
			(App.TGString("Ultra"), ET_EXPFX_SPK_LEVEL, 4))

	pButton = CreateMenuToggleButton(App.TGString("Explosion Spark Level: "), kStates, Custom.NanoFXv2Lite.NanoFX_Config.eFX_ExpSparkFXLevel - 1, MainConfigure.GetWidth())
	pButton.SetVisible()
	...
	kStates = (	(App.TGString("Low"), ET_EXPFX_DAM_SPK_LEVEL, 1),
			...
			(App.TGString("Ultra"), ET_EXPFX_DAM_SPK_LEVEL, 4))

	pButton = CreateMenuToggleButton(App.TGString("Damage Spark Level: "), kStates, Custom.NanoFXv2Lite.NanoFX_Config.eFX_DamageSparkFXLevel - 1, MainConfigure.GetWidth())
	pButton.SetVisible()
	...
	eFXDamageSparkDurationPreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.eFX_DamageSparkFXDuration)), UseExpFX.GetWidth())
	...
	kStates = (	(App.TGString("Low"), ET_EXPFX_DEBRIS_LEVEL, 1),
			...
			(App.TGString("Ultra"), ET_EXPFX_DEBRIS_LEVEL, 4))

	pButton = CreateMenuToggleButton(App.TGString("Debris Level: "), kStates, Custom.NanoFXv2Lite.NanoFX_Config.eFX_DebrisFXLevel - 1, MainConfigure.GetWidth())
	pButton.SetVisible()
	...
	eFXDebrisFXDurationPreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.eFX_DebrisFXDuration)), UseExpFX.GetWidth())
	...
	eFXParticleControlTextPre = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.eFX_ParticleControl)), UseExpFX.GetWidth())
	...
	if Custom.NanoFXv2Lite.NanoFX_Config.eFX_RotationFX:
		LightFX.SetChosen(1)
	else:
		LightFX.SetChosen(0)
	...
	eFXSplashRadiusTextPre = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.eFX_SplashRadius)), UseExpFX.GetWidth())
...
def HandleUseExpFX(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.eFX_Enabled = App.STButton_Cast(pEvent.GetSource()).IsChosen()
	WriteConfig()
...
def HandleExpLightFX(pObject, pEvent):
	...
	Custom.NanoFXv2Lite.NanoFX_Config.eFX_LightFlickerFX = pButton.IsChosen()
	WriteConfig()
...
def HandleFixBright(pObject, pEvent):
	pButton = App.STButton_Cast(pEvent.GetSource())
	Custom.NanoFXv2Lite.NanoFX_Config.eFX_FixBrightGlows = pButton.IsChosen()
	WriteConfig()
...
def HandleExpFX_EXP_SPK(pObject, pEvent):
	pButton = App.STButton_Cast(pEvent.GetSource())
	Custom.NanoFXv2Lite.NanoFX_Config.eFX_ExpSparkFXLevel = pEvent.GetInt()
...
def HandleRotation(pObject, pEvent):
	pButton = App.STButton_Cast(pEvent.GetSource())
	Custom.NanoFXv2Lite.NanoFX_Config.eFX_Rotation = pButton.IsChosen()
	WriteConfig()
...
def HandleWarpFX(pObject, pEvent):
	...
	pEvent.SetDestination(MainConfigure)
	UseWarpFX = MainMenu.mainmenu.CreateMenuYesNoButton(App.TGString("Enhance Warp Sequences"), ET_USEWARPFX, Custom.NanoFXv2Lite.NanoFX_Config.wFX_Enabled, MainConfigure.GetWidth() / 5)
	pEvent.SetSource(UseWarpFX)


	pOptionsWindow.RemoveHandlerForInstance(ET_USEWARPFX, "Custom.NanoFXv2Lite.NanoFX_ConfigPanel.HandleUseWarpFX")
	pOptionsWindow.AddPythonFuncHandlerForInstance(ET_USEWARPFX, "Custom.NanoFXv2Lite.NanoFX_ConfigPanel.HandleUseWarpFX")
	MainConfigure.AddChild(UseWarpFX, 0.0, (WarpFX.GetHeight()) * 4, 0)
	UseWarpFX.SetChosen(Custom.NanoFXv2Lite.NanoFX_Config.wFX_Enabled)
	...
	wFXMaxRandomDistanceTextPre = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.wFX_MaxRandomDistance)), UseWarpFX.GetWidth())
...
def HandleUseWarpFX(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.wFX_Enabled = App.STButton_Cast(pEvent.GetSource()).IsChosen ()
	WriteConfig()
...
def HandleCameraFX(pObject, pEvent):
	...
	pEvent.SetDestination(MainConfigure)
	UseCameraFX = MainMenu.mainmenu.CreateMenuYesNoButton(App.TGString("Enable Camera Effects"), ET_USECAMERAFX, Custom.NanoFXv2Lite.NanoFX_Config.cFX_Enabled, MainConfigure.GetWidth() / 5)
	pEvent.SetSource(UseCameraFX)


	pOptionsWindow.RemoveHandlerForInstance(ET_USECAMERAFX, "Custom.NanoFXv2Lite.NanoFX_ConfigPanel.HandleUseCameraFX")
	pOptionsWindow.AddPythonFuncHandlerForInstance(ET_USECAMERAFX, "Custom.NanoFXv2Lite.NanoFX_ConfigPanel.HandleUseCameraFX")
	MainConfigure.AddChild(UseCameraFX, 0.0, (CameraFX.GetHeight()) * 4, 0)
	UseCameraFX.SetChosen(Custom.NanoFXv2Lite.NanoFX_Config.cFX_Enabled)
	...
	cFXViewScreenDefaultPreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.cFX_ViewScreenDefault)), UseCameraFX.GetWidth())
	...
	cFXViewScreenMaxPreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.cFX_ViewScreenMax)), UseCameraFX.GetWidth())
	...
	cFXAwayDistancePreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.cFX_AwayDistance)), UseCameraFX.GetWidth())
	...
	cFXAwayForwardPreText = CreateTextEntry(App.TGString(str(Custom.NanoFXv2Lite.NanoFX_Config.cFX_ForwardDistance)), UseCameraFX.GetWidth())
...
def HandleUseCameraFX(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.cFX_Enabled = App.STButton_Cast(pEvent.GetSource()).IsChosen ()
	WriteConfig()
...
def HandleSpecialFX(pObject, pEvent):
	...
	pEvent.SetDestination(MainConfigure)
	UseSpecialFX = MainMenu.mainmenu.CreateMenuYesNoButton(App.TGString("Enable Special Effects"), ET_USESPECIALFX, Custom.NanoFXv2Lite.NanoFX_Config.sFX_Enabled, MainConfigure.GetWidth() / 5)
	...
	UseSpecialFX.SetChosen(Custom.NanoFXv2Lite.NanoFX_Config.sFX_Enabled)
	...
	if Custom.NanoFXv2Lite.NanoFX_Config.sFX_AtmosphereGlowFX== "On":
...
def HandleUseSpecialFX(pObject, pEvent):
	Custom.NanoFXv2Lite.NanoFX_Config.sFX_Enabled = App.STButton_Cast(pEvent.GetSource()).IsChosen ()
	WriteConfig()
...
def HandleUseAtmosFX(pObject, pEvent):
	if App.STButton_Cast(pEvent.GetSource()).IsChosen() == 1:
		Custom.NanoFXv2Lite.NanoFX_Config.sFX_AtmosphereGlowFX = "On"
	else:
		Custom.NanoFXv2Lite.NanoFX_Config.sFX_AtmosphereGlowFX = "Off"
	WriteConfig()
...
def HandlePlasmaFX(pObject, pEvent):
	if App.STButton_Cast(pEvent.GetSource()).IsChosen() == 1:
		Custom.NanoFXv2Lite.NanoFX_Config.sFX_PlasmaFX = "On"
	else:
		Custom.NanoFXv2Lite.NanoFX_Config.sFX_PlasmaFX = "Off"
	WriteConfig()
...
def HandleDefault(pObject, pEvent):
	...
	m = __import__("Custom.NanoFXv2Lite.NanoFX_Config")
	...
	m.eFX_Enabled = TRUE
	m.eFX_LightFlickerFX = "Off"
	m.eFX_FixBrightGlows = "Off"

	m.eFX_ExpSparkFXLevel = 3
	m.eFX_DamageSparkFXLevel = 3
	m.eFX_DamageSparkFXDuration = 15.0
	m.eFX_DebrisFXLevel = 3
	m.eFX_DebrisFXDuration = 10.0
	m.eFX_RotationFX = "On"
	m.eFX_ParticleControl = 100
	m.eFX_SplashRadius = 15.0
	...
	Out = Out + "bFX_DamageSparkFXDuration = 15.0\n"
	Out = Out + "bFX_ParticleControl = 80\n"
	Out = Out + "###\n"
	...
	Out = Out + "###\n"
	Out = Out + "eFX_LightFlickerFX = 0\n"
	Out = Out + "eFX_FixBrightGlows = 0\n"
	Out = Out + "eFX_ExpSparkFXLevel = 3\n"
	Out = Out + "eFX_DamageSparkFXLevel = 3\n"
	Out = Out + "eFX_DamageSparkFXDuration = 20.0\n"
	Out = Out + "eFX_DebrisFXLevel = 3\n"
	Out = Out + "eFX_DebrisFXDuration = 10.0\n"
	Out = Out + "eFX_ParticleControl = 100\n"
	Out = Out + "eFX_RotationFX = 1\n"
	Out = Out + "eFX_SplashRadius = 25.0\n"
	Out = Out + "###\n"
	Out = Out + "###[SpecialFX Settings]###\n"
	Out = Out + "sFX_Enabled = TRUE\n"
	Out = Out + "###\n"
	Out = Out + "sFX_AtmosphereGlowFX = 1\n"
	Out = Out + "sFX_PlasmaFX = 1\n"
	Out = Out + "###\n"
...
def WriteConfig(pObject = None, pEvent = None):
	...
	Out = Out + "eFX_LightFlickerFX = \"" + str(m.eFX_LightFlickerFX) + "\"" + n

	Out = Out + "eFX_FixBrightGlows = \"" + str(m.eFX_FixBrightGlows) + "\"" + n
	...
	Out = Out + "eFX_RotationFX = \"" + str(m.eFX_RotationFX) + "\"" + n
	...
	Out = Out + "sFX_AtmosphereGlowFX = \"" + str(m.sFX_AtmosphereGlowFX) + "\"" + n
	Out = Out + "sFX_PlasmaFX = \"" + str(m.sFX_PlasmaFX) + "\"" + n
