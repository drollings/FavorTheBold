...
def Create(pTorp):
	...
	pTorp.CreateDisruptorModel(kOuterShellColor,kOuterCoreColor, 1.3, 0.085)
	...
	pTorp.SetNetType (Multiplayer.SpeciesToTorp.BREENDISRUPTOR)
