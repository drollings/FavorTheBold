...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBGroumel/FTBGroumel.NIF",
		# "FilenameMed": "Custom/FTB/Ships/FTBGroumel/FTBGroumelmed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBGroumel/FTBGroumellow.NIF",
		"Name": "Groumal",
		"HardpointFile": "ftb_groumal",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_GROUMAL,
		# "SpecularCoef": 1.5,
	}
	return kShipStats
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		FTB_Support.AddLODs(pLODModel, (pStats['FilenameHigh'], pStats['FilenameLow']), 100, "_glow", None, "_specular")
