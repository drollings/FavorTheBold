...
ForwardSpiralWave.SetMaxCondition(1728.0)
...
AftSpiralWave.SetMaxCondition(1728.0)
...
DorsalBeam1.SetMaxCondition(1728.0)
...
DorsalBeam2.SetMaxCondition(1728.0)
...
VentralBeam1.SetMaxCondition(1728.0)
...
WarpCore.SetMainBatteryLimit(328000.0)
WarpCore.SetBackupBatteryLimit(328000.0)
