# D:\Games\FTB\scripts\ships\Hardpoints\ftb_ktinga.py
...
PortImpulse.SetMaxCondition(1500.0)
PortImpulse.SetCritical(0)
PortImpulse.SetTargetable(1)
PortImpulse.SetPrimary(1)
PortImpulse.SetPosition(-0.144994, -0.780000, 0.013751)
PortImpulse.SetPosition2D(48.8125367223, 63.3643843846)
...
StarImpulse.SetMaxCondition(1536.0)
StarImpulse.SetCritical(0)
StarImpulse.SetTargetable(1)
StarImpulse.SetPrimary(1)
StarImpulse.SetPosition(0.144994, -0.780000, 0.013751)
StarImpulse.SetPosition2D(79.1874632777, 63.3643843846)
...
ImpulseEngine.SetMaxCondition(1629.0)
...
ImpulseEngine.SetPosition2D(64.0, 63.1377856273)
...
PortWarp.SetMaxCondition(1668.0)
PortWarp.SetCritical(0)
PortWarp.SetTargetable(1)
PortWarp.SetPrimary(1)
PortWarp.SetPosition(-0.840000, -0.822788, -0.296898)
PortWarp.SetPosition2D(-23.9861866924, 82.3595864849)
...
StarWarp.SetMaxCondition(1668.0)
StarWarp.SetCritical(0)
StarWarp.SetTargetable(1)
StarWarp.SetPrimary(1)
StarWarp.SetPosition(0.840000, -0.822788, -0.296898)
StarWarp.SetPosition2D(151.986186692, 82.3595864849)
...
ImpulseEngines.SetMaxCondition(1573.0)
...
ImpulseEngines.SetPosition2D(64.0, 64.2584099076)
...
DisruptorBeam1.SetMaxCondition(1728.0)
...
DisruptorBeam1.SetPosition2D(41.0275398728, 64.2947861306)
...
DisruptorBeam1.SetIconPositionX(53)
DisruptorBeam1.SetIconPositionY(56)
...
DisruptorBeam1.SetRechargeRate(0.021)
DisruptorBeam1.SetIndicatorIconNum(510)
DisruptorBeam1.SetIndicatorIconPositionX(46)
DisruptorBeam1.SetIndicatorIconPositionY(76)
...
DisruptorBeam2.SetMaxCondition(1728.0)
...
DisruptorBeam2.SetPosition2D(86.9724601272, 64.2947861306)
...
DisruptorBeam2.SetIconPositionX(78)
DisruptorBeam2.SetIconPositionY(56)
...
DisruptorBeam2.SetRechargeRate(0.021)
DisruptorBeam2.SetIndicatorIconNum(510)
DisruptorBeam2.SetIndicatorIconPositionX(71)
DisruptorBeam2.SetIndicatorIconPositionY(76)
...
DisruptorBeam3.SetMaxCondition(1728.0)
...
DisruptorBeam3.SetPosition2D(49.5362231078, 69.0635675405)
...
DisruptorBeam3.SetIconPositionX(59)
DisruptorBeam3.SetIconPositionY(19)
...
DisruptorBeam3.SetRechargeRate(0.021)
DisruptorBeam3.SetIndicatorIconNum(510)
DisruptorBeam3.SetIndicatorIconPositionX(52)
DisruptorBeam3.SetIndicatorIconPositionY(29)
...
DisruptorBeam4.SetMaxCondition(1728.0)
...
DisruptorBeam4.SetPosition2D(78.4637768922, 69.0635675405)
...
DisruptorBeam4.SetIconPositionX(72)
DisruptorBeam4.SetIconPositionY(19)
...
DisruptorBeam4.SetRechargeRate(0.021)
DisruptorBeam4.SetIndicatorIconNum(510)
DisruptorBeam4.SetIndicatorIconPositionX(65)
DisruptorBeam4.SetIndicatorIconPositionY(29)
...
DisruptorBeam5.SetMaxCondition(1728.0)
...
DisruptorBeam5.SetPosition2D(51.3093542606, 62.7517242379)
...
DisruptorBeam5.SetIconPositionX(60)
...
DisruptorBeam5.SetRechargeRate(0.021)
DisruptorBeam5.SetIndicatorIconNum(510)
DisruptorBeam5.SetIndicatorIconPositionX(53)
...
DisruptorBeam6.SetMaxCondition(1728.0)
...
DisruptorBeam6.SetPosition2D(76.6906457394, 62.7517242379)
...
DisruptorBeam6.SetIconPositionX(71)
...
DisruptorBeam6.SetRechargeRate(0.021)
DisruptorBeam6.SetIndicatorIconNum(510)
DisruptorBeam6.SetIndicatorIconPositionX(64)
...
StarCannon.SetMaxCondition(1831.0)
StarCannon.SetCritical(0)
StarCannon.SetTargetable(1)
StarCannon.SetPrimary(1)
StarCannon.SetPosition(0.822977, -0.480037, -0.304805)
StarCannon.SetPosition2D(150.203104721, 76.6813277565)
...
StarCannon.SetIconPositionX(127)
StarCannon.SetIconPositionY(95)
...
StarCannon.SetRechargeRate(0.094)
StarCannon.SetIndicatorIconNum(513)
StarCannon.SetIndicatorIconPositionX(109)
StarCannon.SetIndicatorIconPositionY(92)
...
PortCannon.SetMaxCondition(1831.0)
PortCannon.SetCritical(0)
PortCannon.SetTargetable(1)
PortCannon.SetPrimary(1)
PortCannon.SetPosition(-0.822977, -0.480037, -0.304805)
PortCannon.SetPosition2D(-22.2031047209, 76.6813277565)
...
PortCannon.SetIconPositionX(28)
PortCannon.SetIconPositionY(95)
...
PortCannon.SetRechargeRate(0.094)
PortCannon.SetIndicatorIconNum(513)
PortCannon.SetIndicatorIconPositionX(10)
PortCannon.SetIndicatorIconPositionY(92)
...
ShieldGenerator.SetMaxCondition(1465.0)
ShieldGenerator.SetCritical(0)
ShieldGenerator.SetTargetable(1)
ShieldGenerator.SetPrimary(1)
ShieldGenerator.SetPosition(0.000000, 0.015000, 0.040000)
ShieldGenerator.SetPosition2D(64.0, 64.1032017203)
...
WarpCore.SetMaxCondition(2293.0)
WarpCore.SetCritical(1)
WarpCore.SetTargetable(1)
WarpCore.SetPrimary(1)
WarpCore.SetPosition(0.000000, -0.651096, 0.120000)
WarpCore.SetPosition2D(64.0, 59.9168407355)
WarpCore.SetRepairComplexity(2.0)
WarpCore.SetDisabledPercentage(0.5)
WarpCore.SetRadius(0.120000)
WarpCore.SetMainBatteryLimit(380000.0)
WarpCore.SetBackupBatteryLimit(228000.0)
...
CloakingDevice.SetMaxCondition(1482.0)
...
FwdTorpedo1.SetMaxCondition(1536.0)
FwdTorpedo1.SetCritical(0)
FwdTorpedo1.SetTargetable(1)
FwdTorpedo1.SetPrimary(1)
FwdTorpedo1.SetPosition(0.000000, 1.182660, -0.041041)
FwdTorpedo1.SetPosition2D(64.0, 61.1584429635)
...
AftTorpedo.SetMaxCondition(1728.0)
AftTorpedo.SetCritical(0)
AftTorpedo.SetTargetable(1)
AftTorpedo.SetPrimary(1)
AftTorpedo.SetPosition(0.000000, -0.815803, 0.050334)
AftTorpedo.SetPosition2D(64.0, 61.6426104965)
...
DisruptorBeams.SetMaxCondition(1536.0)
...
DisruptorBeams.SetNormalPowerPerSecond(550.0)
...
DisruptorCannons.SetMaxCondition(1536.0)
...
AftTractor.SetMaxCondition(1629.0)
AftTractor.SetCritical(0)
AftTractor.SetTargetable(1)
AftTractor.SetPrimary(1)
AftTractor.SetPosition(0.000000, -0.884399, 0.155946)
AftTractor.SetPosition2D(64.0, 56.746174401)
...
ForwardTractor.SetMaxCondition(1728.0)
ForwardTractor.SetCritical(0)
ForwardTractor.SetTargetable(1)
ForwardTractor.SetPrimary(1)
ForwardTractor.SetPosition(0.000000, 1.221010, 0.026638)
ForwardTractor.SetPosition2D(64.0, 65.9813513789)
...
ForwardTractor.SetIconPositionY(21)
...
ForwardTractor.SetIndicatorIconPositionY(21)
...
D7.SetSpecies(402)
D7.SetMass(48.0)
D7.SetRotationalInertia(24501.0)
D7.SetShipName("FTB_D7")
D7.SetModelFilename("Custom/FTB/Ships/FTBD7/FTB_D7.nif")
D7.SetDamageResolution(10.000000)
D7.SetAffiliation(0)
D7.SetStationary(0)
D7.SetAIString("NonFedAttack")
D7.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(D7)
#################################################
RepairSystem = App.RepairSubsystemProperty_Create("Repair System")
RepairSystem.SetMaxCondition(1536.0)
...
RepairSystem.SetPosition2D(63.5220464644, 59.8160414552)
...
RepairSystem.SetMaxRepairPoints(3.44)
RepairSystem.SetNumRepairTeams(2)
App.g_kModelPropertyManager.RegisterLocalTemplate(RepairSystem)
#################################################
SensorArray = App.SensorProperty_Create("Sensor Array")
SensorArray.SetMaxCondition(2151.0)
SensorArray.SetCritical(0)
SensorArray.SetTargetable(0)
SensorArray.SetPrimary(1)
SensorArray.SetPosition(0.000000, 1.200000, 0.126555)
SensorArray.SetPosition2D(64.0, 73.7848021656)
...
WarpEngines.SetMaxCondition(1536.0)
...
WarpEngines.SetPosition2D(88.9244965262, 63.1407910829)
...
Torpedoes.SetMaxCondition(1368.0)
...
Torpedoes.SetNormalPowerPerSecond(550.0)
...
Torpedoes.SetMaxTorpedoes(0, 130)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("D7", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
