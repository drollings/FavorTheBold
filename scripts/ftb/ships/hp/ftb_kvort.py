...
ImpulseEngine.SetMaxCondition(2478.0)
...
PortWarp.SetMaxCondition(2623.0)
...
StarWarp.SetMaxCondition(2623.0)
...
ImpulseEngines.SetMaxCondition(2653.0)
...
ImpulseEngines.SetNormalPowerPerSecond(2166.98926829)
ImpulseEngines.SetMaxAccel(2.775)
ImpulseEngines.SetMaxAngularAccel(0.1624)
ImpulseEngines.SetMaxAngularVelocity(0.4844)
...
PortMk12Disruptor1.SetMaxCondition(2932.0)
...
PortMk12Disruptor1.SetMaxDamage(375.0)
...
PortMk12Disruptor1.SetRechargeRate(0.049)
...
PortMk12Disruptor1.SetModuleName('ftb.Projectiles.FTBMk12PulseDisruptor')
...
StarMk12Disruptor1.SetMaxCondition(2932.0)
...
StarMk12Disruptor1.SetMaxDamage(375.0)
...
StarMk12Disruptor1.SetRechargeRate(0.049)
...
StarMk12Disruptor1.SetModuleName('ftb.Projectiles.FTBMk12PulseDisruptor')
...
PortMk12Disruptor2.SetMaxCondition(2932.0)
...
PortMk12Disruptor2.SetMaxDamage(375.0)
...
PortMk12Disruptor2.SetRechargeRate(0.049)
...
PortMk12Disruptor2.SetModuleName('ftb.Projectiles.FTBMk12PulseDisruptor')
...
StarMk12Disruptor2.SetMaxCondition(2932.0)
...
StarMk12Disruptor2.SetMaxDamage(375.0)
...
StarMk12Disruptor2.SetRechargeRate(0.049)
...
StarMk12Disruptor2.SetModuleName('ftb.Projectiles.FTBMk12PulseDisruptor')
...
FwdMk6Disruptor1.SetMaxCondition(1963.0)
...
FwdMk6Disruptor1.SetRechargeRate(0.019)
...
FwdMk6Disruptor2.SetMaxCondition(1963.0)
...
FwdMk6Disruptor2.SetRechargeRate(0.019)
...
AftMk6Disruptor2.SetMaxCondition(1963.0)
...
AftMk6Disruptor2.SetRechargeRate(0.019)
...
AftMk6Disruptor1.SetMaxCondition(1963.0)
...
AftMk6Disruptor1.SetRechargeRate(0.019)
...
PortCannon.SetMaxCondition(2932.0)
PortCannon.SetCritical(0)
PortCannon.SetTargetable(1)
PortCannon.SetPrimary(1)
PortCannon.SetPosition(-1.997980, 0.851158, 0.015114)
PortCannon.SetPosition2D(-60.895706, 64.278328)
PortCannon.SetRepairComplexity(3.2)
PortCannon.SetDisabledPercentage(0.75)
PortCannon.SetRadius(0.450000)
...
PortCannon.SetIconPositionX(16.000000)
PortCannon.SetIconPositionY(45.000000)
...
PortCannon.SetRechargeRate(0.019)
PortCannon.SetIndicatorIconNum(512)
PortCannon.SetIndicatorIconPositionX(-2.000000)
PortCannon.SetIndicatorIconPositionY(42.000000)
...
StarCannon.SetMaxCondition(2932.0)
StarCannon.SetCritical(0)
StarCannon.SetTargetable(1)
StarCannon.SetPrimary(1)
StarCannon.SetPosition(-1.997980, 0.851158, 0.015114)
StarCannon.SetPosition2D(-60.895706, 64.278328)
StarCannon.SetRepairComplexity(3.2)
StarCannon.SetDisabledPercentage(0.75)
StarCannon.SetRadius(0.450000)
...
StarCannon.SetIconPositionX(16.000000)
StarCannon.SetIconPositionY(45.000000)
...
StarCannon.SetRechargeRate(0.019)
StarCannon.SetIndicatorIconNum(512)
StarCannon.SetIndicatorIconPositionX(-2.000000)
StarCannon.SetIndicatorIconPositionY(42.000000)
...
ShieldGenerator.SetMaxCondition(2046.0)
...
ShieldGenerator.SetNormalPowerPerSecond(1187.5)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 8906.25)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 4453.125)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 8906.25)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 8906.25)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 5937.5)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 5937.5)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 12.3259493671)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 7.39556962025)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 12.3259493671)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 12.3259493671)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 7.39556962025)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 7.39556962025)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShieldGenerator)
#################################################
WarpCore = App.PowerProperty_Create("Warp Core")
WarpCore.SetMaxCondition(3153.0)
...
WarpCore.SetMainBatteryLimit(760000.0)
WarpCore.SetBackupBatteryLimit(342000.0)
...
CloakingDevice.SetMaxCondition(2144.0)
...
ShuttleBay.SetMaxCondition(2010.0)
...
FwdTorpedo.SetMaxCondition(1906.0)
...
FwdTorpedo.SetDamageRadiusFactor(0.15)
...
FwdTorpedo.SetImmediateDelay(0.5)
FwdTorpedo.SetReloadDelay(25.0)
...
AftTorpedo.SetMaxCondition(1850.0)
...
DisruptorCannons.SetMaxCondition(2233.0)
...
DisruptorCannons.SetNormalPowerPerSecond(1050.0)
...
Kvort.SetMass(79.0)
Kvort.SetRotationalInertia(40001.0)
...
Engineering.SetMaxCondition(2273.0)
...
WarpEngines.SetMaxCondition(2478.0)
...
Torpedoes.SetNormalPowerPerSecond(1050.0)
