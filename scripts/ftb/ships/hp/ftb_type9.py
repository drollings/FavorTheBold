# C:\Program Files\Activision\FTB Bridge Commander\scripts\ships\Hardpoints\FTB_Type9.py
...
PortImpulse.SetMaxCondition(962.0)
PortImpulse.SetCritical(0)
PortImpulse.SetTargetable(1)
PortImpulse.SetPrimary(1)
PortImpulse.SetPosition(-0.013199, -0.043000, -0.001700)
PortImpulse.SetPosition2D(27.9009422876, 67.073057363)
...
StarImpulse.SetMaxCondition(962.0)
StarImpulse.SetCritical(0)
StarImpulse.SetTargetable(1)
StarImpulse.SetPrimary(1)
StarImpulse.SetPosition(0.013199, -0.043000, -0.001700)
StarImpulse.SetPosition2D(100.099057712, 67.073057363)
...
PortWarp.SetMaxCondition(976.0)
PortWarp.SetCritical(0)
PortWarp.SetTargetable(1)
PortWarp.SetPrimary(1)
PortWarp.SetPosition(-0.022000, -0.019000, -0.009000)
PortWarp.SetPosition2D(3.83034550544, 73.3145263309)
...
StarWarp.SetMaxCondition(976.0)
StarWarp.SetCritical(0)
StarWarp.SetTargetable(1)
StarWarp.SetPrimary(1)
StarWarp.SetPosition(0.022000, -0.019000, -0.009000)
StarWarp.SetPosition2D(124.169654495, 73.3145263309)
...
ImpulseEngines.SetMaxCondition(962.0)
...
ImpulseEngines.SetNormalPowerPerSecond(2400.0126439)
...
Phaser.SetMaxCondition(961.0)
Phaser.SetCritical(0)
Phaser.SetTargetable(1)
Phaser.SetPrimary(1)
Phaser.SetPosition(0.000578, 0.045801, -0.002385)
Phaser.SetPosition2D(65.5808209226, 59.6943887362)
Phaser.SetRepairComplexity(4.0)
Phaser.SetDisabledPercentage(0.75)
Phaser.SetRadius(0.002000)
Phaser.SetDumbfire(0)
Phaser.SetWeaponID(1)
Phaser.SetGroups(1)
Phaser.SetDamageRadiusFactor(0.11)
Phaser.SetIconNum(364)
Phaser.SetIconPositionX(66)
Phaser.SetIconPositionY(18)
Phaser.SetIconAboveShip(0)
Phaser.SetFireSound('Intrepid Phaser')
Phaser.SetMaxCharge(3.0)
Phaser.SetMaxDamage(1000.0)
Phaser.SetMaxDamageDistance(40.0)
Phaser.SetMinFiringCharge(2.0)
Phaser.SetNormalDischargeRate(1.0)
Phaser.SetRechargeRate(0.034)
Phaser.SetIndicatorIconNum(510)
Phaser.SetIndicatorIconPositionX(59)
Phaser.SetIndicatorIconPositionY(28)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 250.0)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 125.0)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 125.0)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 125.0)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 125.0)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 125.0)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 0.239998735616)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 0.239998735616)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 0.239998735616)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 0.239998735616)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 0.239998735616)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 0.239998735616)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShieldGenerator)
#################################################
WarpCore = App.PowerProperty_Create("Warp Core")
WarpCore.SetMaxCondition(1469.0)
WarpCore.SetCritical(1)
WarpCore.SetTargetable(1)
WarpCore.SetPrimary(1)
WarpCore.SetPosition(0.000000, -0.013000, -0.008400)
WarpCore.SetPosition2D(64.0, 70.4875246371)
WarpCore.SetRepairComplexity(2.0)
WarpCore.SetDisabledPercentage(0.5)
WarpCore.SetRadius(0.004000)
WarpCore.SetMainBatteryLimit(42000.0)
WarpCore.SetBackupBatteryLimit(21000.0)
WarpCore.SetMainConduitCapacity(1680.0)
WarpCore.SetBackupConduitCapacity(560.0)
WarpCore.SetPowerOutput(1400.0)
App.g_kModelPropertyManager.RegisterLocalTemplate(WarpCore)
#################################################
Hull = App.HullProperty_Create("Hull")
Hull.SetMaxCondition(3994.0)
Hull.SetCritical(1)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 0.050000, 0.010000)
...
FirstPersonCameraPosition.SetXYZ(0.000000, 0.070000, 0.000000)
...
ForwardTractor.SetMaxCondition(961.0)
...
ForwardTractor.SetPosition2D(64.0300848272, 59.9490127388)
...
ForwardTractor.SetIconPositionY(39)
...
ForwardTractor.SetIndicatorIconPositionY(39)
...
Type9.SetGenus(1)
Type9.SetSpecies(106)
Type9.SetMass(1.0)
Type9.SetRotationalInertia(2.0)
Type9.SetShipName("FTB_Type9")
Type9.SetModelFilename("Custom/FTB/Ships/FTBType9/FTB_Type9.nif")
...
WarpEngines.SetMaxCondition(970.0)
...
WarpEngines.SetPosition2D(64.0, 75.4539629893)
...
Torpedoes.SetMaxCondition(961.0)
