...
PortImpulse.SetMaxCondition(2694.0)
...
PortImpulse.SetPosition2D(0.0290776919582, 62.464866967)
...
StarImpulse.SetMaxCondition(2694.0)
...
StarImpulse.SetPosition2D(127.970922308, 62.464866967)
...
DorsalPhaser1.SetPosition2D(64.0, 66.7974562799)
...
DorsalPhaser1.SetRechargeRate(0.04)
...
DorsalPhaser2.SetPosition2D(64.0, 66.7974562799)
...
DorsalPhaser2.SetRechargeRate(0.04)
...
DorsalPhaser3.SetPosition2D(64.0, 66.7974562799)
...
DorsalPhaser3.SetRechargeRate(0.04)
...
DorsalPhaser4.SetPosition2D(64.0, 66.7974562799)
...
DorsalPhaser4.SetRechargeRate(0.04)
...
VentralPhaser1.SetPosition2D(64.0, 63.5583255804)
...
VentralPhaser1.SetIconPositionY(74)
...
VentralPhaser2.SetPosition2D(64.0, 63.5583255804)
...
VentralPhaser2.SetIconPositionY(54)
...
VentralPhaser3.SetPosition2D(64.0, 63.5583255804)
...
VentralPhaser3.SetIconPositionY(54)
...
VentralPhaser4.SetPosition2D(64.0, 63.5583255804)
...
VentralPhaser4.SetIconPositionY(74)
...
ShieldGenerator.SetMaxCondition(2632.0)
ShieldGenerator.SetCritical(0)
ShieldGenerator.SetTargetable(1)
ShieldGenerator.SetPrimary(1)
ShieldGenerator.SetPosition(0.000000, -0.400000, 0.240000)
ShieldGenerator.SetPosition2D(64.0, 62.9701661774)
...
WarpCore.SetMaxCondition(3851.0)
WarpCore.SetCritical(1)
WarpCore.SetTargetable(1)
WarpCore.SetPrimary(1)
WarpCore.SetPosition(0.000000, -1.000000, -0.250000)
WarpCore.SetPosition2D(64.0, 69.4330762462)
WarpCore.SetRepairComplexity(2.0)
WarpCore.SetDisabledPercentage(0.5)
WarpCore.SetRadius(0.350000)
WarpCore.SetMainBatteryLimit(1500000.0)
WarpCore.SetBackupBatteryLimit(480000.0)
WarpCore.SetMainConduitCapacity(7200.0)
WarpCore.SetBackupConduitCapacity(2400.0)
WarpCore.SetPowerOutput(6000.0)
App.g_kModelPropertyManager.RegisterLocalTemplate(WarpCore)
#################################################
Hull = App.HullProperty_Create("Hull")
Hull.SetMaxCondition(7366.0)
Hull.SetCritical(1)
Hull.SetTargetable(1)
Hull.SetPrimary(1)
Hull.SetPosition(0.000000, -1.100000, -0.280000)
Hull.SetPosition2D(64.0, 70.7116756024)
...
ForwardTorp1.SetMaxCondition(2543.0)
...
ForwardTorp1.SetPosition2D(57.02135393, 59.8806647096)
...
ForwardTorp1.SetIconPositionX(73)
...
ForwardTorp2.SetMaxCondition(2543.0)
...
ForwardTorp2.SetPosition2D(59.9291231259, 60.0582222653)
...
ForwardTorp2.SetIconPositionX(75)
...
ForwardTorp3.SetMaxCondition(2543.0)
...
ForwardTorp3.SetPosition2D(68.0708768741, 60.0582222653)
...
ForwardTorp3.SetIconPositionX(78)
...
ForwardTorp4.SetMaxCondition(2543.0)
...
ForwardTorp4.SetPosition2D(70.97864607, 59.8806647096)
...
ForwardTorp4.SetIconPositionX(82)
...
AftTorp1.SetIconPositionX(75)
AftTorp1.SetIconPositionY(104)
...
AftTorp2.SetIconPositionX(78)
AftTorp2.SetIconPositionY(104)
...
Phasers.SetMaxCondition(2400.0)
...
Phasers.SetNormalPowerPerSecond(1475.0)
...
AftTractor.SetMaxCondition(2400.0)
...
AftTractor.SetPosition2D(64.0, 61.2419393027)
...
ForwardTractor.SetPosition2D(64.0, 67.3380820456)
...
Repair.SetPosition2D(64.0, 60.9852206702)
...
SensorArray.SetPosition2D(64.0, 66.552389862)
...
WarpEngines.SetPosition2D(64.0, 70.066549817)
...
Torpedoes.SetNormalPowerPerSecond(1475.0)
