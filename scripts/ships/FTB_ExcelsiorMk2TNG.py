...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBLakota/FTB_Enterprise_B.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBLakota/FTB_Enterprise_BMed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBLakota/FTB_Enterprise_B_Low.NIF",
		"Name": "Excelsior Mk2 TNG",
		"HardpointFile": "ftb_excelsiormk2tng",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_LAKOTA,
		# "SpecularCoef": 1.5,
		# "DamageRadMod" : 0.8,
		# "DamageStrMod" : 0.3
	}
...
def GetPath():
	return 'Custom/FTB/Ships/FTBLakota/'
