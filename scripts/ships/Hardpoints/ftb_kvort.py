...
PortMk12Disruptor1.SetRechargeRate(0.059)
...
StarMk12Disruptor1.SetRechargeRate(0.059)
...
PortMk12Disruptor2.SetRechargeRate(0.059)
...
StarMk12Disruptor2.SetRechargeRate(0.059)
...
PortCannon.SetRechargeRate(0.022)
...
StarCannon.SetRechargeRate(0.022)
...
ShieldGenerator.SetNormalPowerPerSecond(1218.75)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 9140.625)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 4570.3125)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 9140.625)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 9140.625)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 6093.75)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 6093.75)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 12.6503164557)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 7.59018987342)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 12.6503164557)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 12.6503164557)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 7.59018987342)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 7.59018987342)
...
WarpCore.SetBackupBatteryLimit(360000.0)
...
DisruptorCannons.SetNormalPowerPerSecond(1240.0)
...
Torpedoes.SetNormalPowerPerSecond(1240.0)
