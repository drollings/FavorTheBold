...
CargoHold.SetMaxCondition(1354.0)
CargoHold.SetCritical(0)
CargoHold.SetTargetable(0)
CargoHold.SetPrimary(0)
CargoHold.SetPosition(0.000000, -0.420000, 0.100000)
CargoHold.SetPosition2D(64.0, -243.420841094)
CargoHold.SetRepairComplexity(3.0)
CargoHold.SetDisabledPercentage(0.5)
