...
PortImpulse.SetMaxCondition(2262.0)
...
PortImpulse.SetPosition2D(44.8191808192, 53.0012085816)
...
StarImpulse.SetMaxCondition(2262.0)
...
StarImpulse.SetPosition2D(83.1808191808, 53.0012085816)
...
WarpEngine.SetMaxCondition(2524.0)
...
WarpEngine.SetPosition2D(64.0, 55.6838406349)
...
ShieldGenerator.SetMaxCondition(1907.0)
ShieldGenerator.SetCritical(0)
ShieldGenerator.SetTargetable(1)
ShieldGenerator.SetPrimary(1)
ShieldGenerator.SetPosition(0.000000, 0.600000, 0.200000)
ShieldGenerator.SetPosition2D(64.0, 77.2343181294)
...
Hull.SetPosition2D(64.0, 69.9912115856)
...
TractorBeam.SetMaxCondition(2020.0)
...
TractorBeam.SetPosition2D(64.0, 69.7229483803)
TractorBeam.SetRepairComplexity(3.0)
TractorBeam.SetDisabledPercentage(0.75)
...
TractorBeam.SetIconPositionX(80)
TractorBeam.SetIconPositionY(105)
TractorBeam.SetIconAboveShip(0)
TractorBeam.SetFireSound("Tractor Beam")
TractorBeam.SetMaxCharge(5.000000)
TractorBeam.SetMaxDamage(12.0)
...
TractorBeam.SetIndicatorIconPositionX(80)
TractorBeam.SetIndicatorIconPositionY(105)
...
Freighter.SetMass(196.0)
Freighter.SetRotationalInertia(100001.0)
...
SensorArray.SetPosition2D(64.0, 84.3880036048)
