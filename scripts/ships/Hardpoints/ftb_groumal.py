...
PortImpulse.SetMaxCondition(1308.0)
...
PortImpulse.SetPosition2D(46.944703531, 50.9954784752)
...
StarImpulse.SetMaxCondition(1308.0)
...
StarImpulse.SetPosition2D(81.055296469, 49.8024031059)
...
ImpulseEngines.SetMaxCondition(1386.0)
...
ImpulseEngines.SetNormalPowerPerSecond(1856.69707317)
ImpulseEngines.SetMaxAccel(2.4)
ImpulseEngines.SetMaxAngularAccel(0.15065)
ImpulseEngines.SetMaxAngularVelocity(0.429525)
...
ShieldGenerator.SetMaxCondition(1308.0)
ShieldGenerator.SetCritical(0)
ShieldGenerator.SetTargetable(1)
ShieldGenerator.SetPrimary(1)
ShieldGenerator.SetPosition(0.000000, 0.750000, 0.100000)
ShieldGenerator.SetPosition2D(64.0, 67.261072676)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 6250.0)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 6250.0)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 11.6587677725)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 11.6587677725)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 11.6587677725)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 11.6587677725)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 11.6587677725)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 11.6587677725)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShieldGenerator)
#################################################
WarpCore = App.PowerProperty_Create("Warp Core")
WarpCore.SetMaxCondition(2013.0)
WarpCore.SetCritical(1)
WarpCore.SetTargetable(1)
WarpCore.SetPrimary(1)
WarpCore.SetPosition(0.000000, 0.600000, 0.200000)
WarpCore.SetPosition2D(64.0, 69.8858384883)
...
Tractors.SetMaxCondition(1386.0)
...
Tractors.SetNormalPowerPerSecond(103.0)
...
TractorBeam.SetMaxCondition(1308.0)
...
TractorBeam.SetPosition2D(64.0, 46.5313881352)
...
TractorBeam.SetIndicatorIconPositionY(25)
...
Cardfreighter.SetMass(15.0)
Cardfreighter.SetRotationalInertia(7501.0)
...
Engineering.SetMaxCondition(1386.0)
...
WarpEngines.SetMaxCondition(1386.0)
