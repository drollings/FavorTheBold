...
PortImpulse.SetMaxCondition(994.0)
...
PortImpulse.SetPosition2D(11.1074380165, 52.3062850898)
...
StarImpulse.SetMaxCondition(994.0)
...
StarImpulse.SetPosition2D(116.892561983, 52.3062850898)
...
ShieldGenerator.SetMaxCondition(1005.0)
ShieldGenerator.SetCritical(0)
ShieldGenerator.SetTargetable(1)
ShieldGenerator.SetPrimary(1)
ShieldGenerator.SetPosition(0.000000, -0.040000, 0.040000)
ShieldGenerator.SetPosition2D(64.0, 61.0624957312)
...
ForwardTractor.SetMaxCondition(1005.0)
...
ForwardTractor.SetPosition2D(64.0, 57.0846253671)
...
Shuttle.SetMass(1.0)
Shuttle.SetRotationalInertia(2.0)
...
WarpEngines.SetPosition2D(64.0, 65.7135441568)
