...
Engine1.SetMaxCondition(2510.0)
...
Engine2.SetMaxCondition(2510.0)
...
Engine3.SetMaxCondition(2370.0)
...
Engine4.SetMaxCondition(2370.0)
...
ImpulseEngines.SetMaxCondition(2109.0)
...
PortBeam.SetMaxCondition(2510.0)
...
StarBeam.SetMaxCondition(2510.0)
...
AftBeam.SetMaxCondition(2236.0)
...
ShieldGenerator.SetMaxCondition(2510.0)
...
WarpCore.SetMaxCondition(3968.0)
...
WarpCore.SetMainBatteryLimit(644000.0)
WarpCore.SetBackupBatteryLimit(276000.0)
...
ForwardTorpedo.SetMaxCondition(1988.0)
...
SensorArray.SetMaxCondition(3041.0)
...
WarpEngine.SetMaxCondition(2109.0)
