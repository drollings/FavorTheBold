...
ImpulseEngines.SetMaxCondition(3875.0)
...
ShieldGenerator.SetMaxCondition(33667.0)
...
PowerPlant.SetMaxCondition(34367.0)
...
PowerPlant.SetPosition2D(64.0, 126.70432294)
...
Transmitter1.SetMaxCondition(8383.0)
Transmitter1.SetCritical(0)
Transmitter1.SetTargetable(0)
Transmitter1.SetPrimary(0)
Transmitter1.SetPosition(0.000000, 0.000000, 8.000000)
Transmitter1.SetPosition2D(64.0, 126.70432294)
Transmitter1.SetRepairComplexity(3.0)
Transmitter1.SetDisabledPercentage(0.5)
...
Transmitter2.SetMaxCondition(14851.0)
Transmitter2.SetCritical(0)
Transmitter2.SetTargetable(0)
Transmitter2.SetPrimary(0)
Transmitter2.SetPosition(10.000000, 0.000000, -0.300000)
Transmitter2.SetPosition2D(223.9800025, 64.0881779541)
Transmitter2.SetRepairComplexity(3.0)
Transmitter2.SetDisabledPercentage(0.5)
...
Receiver.SetMaxCondition(14851.0)
Receiver.SetCritical(0)
Receiver.SetTargetable(0)
Receiver.SetPrimary(0)
Receiver.SetPosition(-10.000000, 0.000000, -0.200000)
Receiver.SetPosition2D(-95.9800024997, 64.0391902018)
Receiver.SetRepairComplexity(3.0)
Receiver.SetDisabledPercentage(0.5)
