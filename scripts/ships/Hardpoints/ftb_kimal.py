...
Impulse.SetMaxCondition(1577.0)
...
PortImpulse.SetMaxCondition(1754.0)
...
StarImpulse.SetMaxCondition(1754.0)
...
ImpulseEngines.SetMaxCondition(1615.0)
...
ForwardBeam.SetMaxCondition(1653.0)
...
ShieldGenerator.SetMaxCondition(1615.0)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 11.6809116809)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 11.6809116809)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 11.6809116809)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 11.6809116809)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 11.6809116809)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 11.6809116809)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShieldGenerator)
#################################################
WarpCore = App.PowerProperty_Create("Warp Core")
WarpCore.SetMaxCondition(2428.0)
...
ForwardTorpedo.SetMaxCondition(1558.0)
...
Compressors.SetMaxCondition(1653.0)
...
RepairSubsystem.SetMaxCondition(1522.0)
...
WarpEngine.SetMaxCondition(1615.0)
