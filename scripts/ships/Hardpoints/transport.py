...
PortImpulse.SetMaxCondition(1907.0)
...
StarImpulse.SetMaxCondition(1907.0)
...
PortWarp.SetMaxCondition(2807.0)
...
StarWarp.SetMaxCondition(2807.0)
...
ImpulseEngines.SetMaxCondition(1907.0)
...
ImpulseEngines.SetNormalPowerPerSecond(2451.13902439)
ImpulseEngines.SetMaxAccel(2.25)
ImpulseEngines.SetMaxAngularAccel(0.14385)
ImpulseEngines.SetMaxAngularVelocity(0.403725)
...
DorsalPhaser.SetMaxCondition(1907.0)
...
VentralPhaser.SetMaxCondition(1907.0)
...
ShieldGenerator.SetMaxCondition(2020.0)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 13.8105263158)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 13.8105263158)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 13.8105263158)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 13.8105263158)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 13.8105263158)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 13.8105263158)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShieldGenerator)
#################################################
WarpCore = App.PowerProperty_Create("Warp Core")
WarpCore.SetMaxCondition(2770.0)
...
WarpCore.SetMainBatteryLimit(775000.0)
WarpCore.SetBackupBatteryLimit(248000.0)
...
Tractors.SetMaxCondition(1907.0)
...
Tractors.SetNormalPowerPerSecond(167.0)
...
Phasers.SetMaxCondition(1907.0)
...
Phasers.SetNormalPowerPerSecond(167.0)
...
AftTractor.SetMaxCondition(1907.0)
...
PortTractor.SetMaxCondition(1907.0)
...
PortTractor.SetRepairComplexity(3.0)
PortTractor.SetDisabledPercentage(0.75)
...
PortTractor.SetMaxDamage(12.0)
PortTractor.SetMaxDamageDistance(100.0)
...
StarTractor.SetMaxCondition(1907.0)
...
StarTractor.SetRepairComplexity(3.0)
StarTractor.SetDisabledPercentage(0.75)
...
StarTractor.SetMaxDamage(12.0)
StarTractor.SetMaxDamageDistance(100.0)
...
Transport.SetMass(196.0)
Transport.SetRotationalInertia(100001.0)
...
RepairSystem.SetMaxCondition(1907.0)
...
WarpEngines.SetMaxCondition(1907.0)
