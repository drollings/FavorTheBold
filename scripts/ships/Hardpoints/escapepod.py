...
PortImpulse.SetPosition2D(-51.512195122, 137.556216538)
...
StarImpulse.SetPosition2D(179.512195122, 137.556216538)
...
CenterImpulse.SetPosition2D(64.0, 33.6180844735)
...
ShieldGenerator.SetPosition2D(62.3984390244, 62.2510683747)
...
PowerPlant.SetPosition2D(64.0, 64.9327781083)
...
SensorArray.SetPosition2D(64.0, 63.9480009518)
