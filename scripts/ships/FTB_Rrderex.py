...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBRomScout/FTBRomScout.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBRomScout/FTBRomScoutmed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBRomScout/FTBRomScoutlow.NIF",
		"Name": "Rrderex",
		"HardpointFile": "ftb_rrderex",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_RRDEREX,
		"SpecularCoef": 1.5,
	}
	return kShipStats
