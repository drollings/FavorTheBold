...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBCentaur/FTB_Centaur.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBCentaur/FTB_CentaurMed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBCentaur/FTB_CentaurLow.NIF",
		"Name": "Mediterranean",
		"HardpointFile": "ftb_mediterranean",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_MEDITERRANEAN,
		# "SpecularCoef": 1.5,
		# "DamageRadMod" : 0.8,
		# "DamageStrMod" : 0.3
	}
...
def GetPath():
	return 'Custom/FTB/Ships/FTBCentaur/'
