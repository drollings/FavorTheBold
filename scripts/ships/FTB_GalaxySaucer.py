...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBGalaxy/FTB_Saucer.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBGalaxy/FTB_SaucerMed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBGalaxy/FTB_SaucerLow.NIF",
		"Name": "FTB_GalaxySaucer",
		"HardpointFile": "ftb_galaxysaucer",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_GALAXY_SAUCER,
		"SpecularCoef": 0.55
		 }
	return kShipStats
...
def GetPath():
	return 'Custom/FTB/Ships/FTBGalaxy/'
