...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBWarbird/FTBWarbird.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBWarbird/FTBWarbirdmed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBWarbird/FTBWarbirdlow.NIF",
		"Name": "E2M0Warbird",
		"HardpointFile": "ftb_dderidex",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_DDERIDEX,
		"SpecularCoef": 1.5,
	}
	return kShipStats
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		FTB_Support.AddLODs(pLODModel, (pStats['FilenameHigh'], pStats['FilenameMed'], pStats['FilenameLow']), 2000, "_glow", None, "_specular")
