...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBEnterprise/FTB_Enterprise.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBEnterprise/FTB_EnterpriseMed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBEnterprise/FTB_EnterpriseLow.NIF",
		"Name": "Enterprise",
		"HardpointFile": "ftb_constitutionmk2",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_CONSTITUTIONMK2,
		# "SpecularCoef": 1.5,
		# "DamageRadMod" : 0.8,
		# "DamageStrMod" : 0.3
	}
...
def GetPath():
	return 'Custom/FTB/Ships/FTBEnterprise/'
