...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "Custom/FTB/Ships/FTBD'Verix/FTB_D'verix.NIF",
		"FilenameMed": "Custom/FTB/Ships/FTBD'Verix/FTB_D'verixmed.NIF",
		"FilenameLow": "Custom/FTB/Ships/FTBD'Verix/FTB_D'verixlow.NIF",
		"Name": "Dverix",
		"HardpointFile": "ftb_dverix",
		"Species": ftb.Multiplayer.SpeciesToShip.FTB_DVERIX,
		"SpecularCoef": 1.5,
	}
	return kShipStats
